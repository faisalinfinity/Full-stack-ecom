          ...
          <Card key={product._id}>
            <CardHeader>
              <img
                ...
                alt={product.name}
                onError={(e) =>
                  (e.currentTarget.src = `https://picsum.photos/seed/${product._id}/400/300`)
                }
                className="max-h-48 w-full h-full object-center object-cover lg:w-full lg:h-full"
              />
            </CardHeader>
            <CardContent>
        ...
        <DialogContent>
          ...
          <div className="py-4">
            ...
            <p className="mt-4 font-semibold">
              Total: ${((selectedProduct?.price || 0) * quantity).toFixed(2)}
            </p>
          </div>
          <DialogFooter>
